...
function search_by_city(){
    let search = addressBook.filter(ele => ele.city == 'Hyderabad');
    if (search != null){
        console.log("Searched Contacts in Hyderabad");
    }
}

function search_by_state(){
    let search = addressBook.filter(ele => ele.state == 'Andhra Pradesh');
    if (search != null) {
        console.log("Searched Contacts in Andhra Pradesh");
    }
}
